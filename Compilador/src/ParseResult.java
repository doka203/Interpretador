...
public class ParseResult {
    ...
    private ParseResult(boolean sucesso, boolean completo, String regraNome, Map<String, Object> valores, String elementoFaltando) {
    ...
    public static ParseResult sucessoIncompleto(String regraNome, String elementoFaltando, Map<String, Object> valoresParciais) {
    ...
    public String getRegraNome() { return regraNome; }
    public Map<String, Object> getValores() { return valores; }
    public String getElementoFaltando() { return elementoFaltando; }
}