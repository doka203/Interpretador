//lista de stopwords https://gist.github.com/alopes/5358189

public class Stopwords {
    String[] stopwords = { "de", "a", "o", "e", "do", "da", "em", "um", "para", "é", "com", "não", "uma", "os",
            "no",
            "se", "na", "por", "mais", "as", "dos", "como", "mas", "foi", "ao", "ele", "das", "tem", "à", "seu", "sua",
            "ou", "ser", "muito", "há", "nos", "já", "está", "eu", "também", "só", "pelo", "pela", "até",
            ...
            "numa", "pelos", "elas", "havia", "seja", "será", "nós", "tenho", "lhe", "deles", "essas", "esses",
